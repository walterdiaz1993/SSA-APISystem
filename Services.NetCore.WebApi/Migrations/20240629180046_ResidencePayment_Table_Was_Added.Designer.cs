...
namespace Services.NetCore.WebApi.Migrations
{
    ...
    [Migration("20240629180046_ResidencePayment_Table_Was_Added")]
    partial class ResidencePayment_Table_Was_Added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Services.NetCore.Domain.Aggregates.InvoiceAgg.Invoice_Transactions", b =>
                {
                    b.Property<int>("UId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Invoice_Transactions", "Payment");
                });
            ...
            modelBuilder.Entity("Services.NetCore.Domain.Aggregates.InvoiceDetailAgg.InvoiceDetail_Transactions", b =>
                {
                    b.Property<int>("UId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InvoiceDetail_Transactions", "Payment");
                });
            ...
            modelBuilder.Entity("Services.NetCore.Domain.Aggregates.ResidencePaymentAgg.ResidencePayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ResidencePayment", "Payment");
                });

            modelBuilder.Entity("Services.NetCore.Domain.Aggregates.ResidencePaymentAgg.ResidencePayment_Transactions", b =>
                {
                    b.Property<int>("UId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ResidencePayment_Transactions", "Payment");
                });
